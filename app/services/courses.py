...
from app.dtos import CoursePastOut, CourseCreateIn, CourseOut
from typing import Any

from app.dtos import CoursePastOut, CourseCreateIn
from app.exceptions import NotFoundError
from app.repositories.courses import CourseRepository, ICourseRepository
...
class CourseService:
    ...
    def __init__(self, repo: ICourseRepository | Any = None) -> None:
        if hasattr(repo, "execute"):  # Is a SQLAlchemy session
