...
class Swagger:
    ...
    SCHEMA_TYPES = ...
    SCHEMA_LOCATIONS = ...
    def __init__(self, app=..., config=..., sanitizer=..., template=..., template_file=..., decorators=..., validation_function=..., validation_error_handler=..., parse=..., format_checker=..., merge=...) -> None:
        ...
    ...
    def load_swagger_file(self, filename): # -> Any:
        ...
    ...
    def get_url_mappings(self, rule_filter=...): # -> list[Rule]:
        """
        Returns all werkzeug rules
        """
        ...
    
    def get_def_models(self, definition_filter=...): # -> dict[Any, Any]:
        """
    ...
    def definition(self, name, tags=...): # -> Callable[..., Any]:
        """
    ...
    def validate(self, schema_id, validation_function=..., validation_error_handler=...): # -> Callable[..., _Wrapped[Callable[..., Any], Any, Callable[..., Any], Any]]:
        """
    ...
    def get_schema(self, schema_id): # -> None:
        """
    ...
    def is_openapi3(self): # -> list[dict[str, str | Callable[..., Literal[True]]]] | bool | Literal[''] | None:
        ...
